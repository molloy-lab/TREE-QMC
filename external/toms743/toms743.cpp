...
/* EKM downloaded toms743.cpp, toms743.hpp, toms743_test.cpp from 
 * https://people.sc.fsu.edu/~jburkardt/cpp_src/toms743/toms743.html 
 * on January 12, 2023.
 *
 * All files are distributed under the MIT license; see licensing below.
 *
 * EKM removed std namespace and added toms743 namespace for safety.
 *
 * Build: g++ -std=c++11 -O2 -o toms743_test *cpp  -lm
 * Run: ./toms743_test
 */
...
double toms743::bisect ( double xx, int nb, int &ner, int l )
...
double toms743::crude ( double xx, int nb )
...
double toms743::wapr ( double x, int nb, int &nerror, int l )
